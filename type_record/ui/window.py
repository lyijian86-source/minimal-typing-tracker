...
class CounterWindow(DialogMixin, WidgetFactoryMixin):
    ...
    def _schedule_refresh(self) -> None:
        ...
        self.settings_var.set(tr(self.config.language, "stored_settings", space=tr(self.config.language, "on") if self.config.count_space else tr(self.config.language, "off"), enter=tr(self.config.language, "on") if self.config.count_enter else tr(self.config.language, "off"), clipboard=tr(self.config.language, "on") if self.config.count_clipboard_changes else tr(self.config.language, "off"), backspace=tr(self.config.language, "subtracts") if self.config.backspace_decrements else tr(self.config.language, "ignored"), hidden=tr(self.config.language, "on") if self.config.start_hidden_to_tray else tr(self.config.language, "off"), lang_name=tr(self.config.language, "language_name")))
